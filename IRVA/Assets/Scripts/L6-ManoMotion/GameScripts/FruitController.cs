...
namespace AR_ManoMotion
{
    public class FruitController : MonoBehaviour
    {
        ...
        public void DestroyFruitInstance()
        {
            ...
            //    -> Effect is automatically played (see 'Play On Awake' property on particle in Inspector)
            //    -> Effect is automatically destroyed after playing (see 'Stop Action' property on particle effect in Inspector)
